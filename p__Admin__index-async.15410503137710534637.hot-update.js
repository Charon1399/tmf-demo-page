globalThis.makoModuleHotUpdate('p__Admin__index', {
    modules: {
        "src/pages/Admin/ResourceAgent/TaskWorkflow.js": function(module, exports, __mako_require__) {
            ...
            const TaskWorkflow = ({ readyStatus, setReadyStatus })=>{
                ...
                const [count, setCount] = (0, _react.useState)(initConut + 2);
                const totalExecutions = 9;
                // 进来的值从local中拿
                let executionCount = initConut + 2;
                (0, _react.useEffect)(()=>{
                    // 创建一个新的定时器，在每一秒钟执行一次函数来更新时间状态。
  ...
  "supportedBy": [
      ...
      "serviceCharacteristic": [
        {
          ...
          "value": "Daily incremental backup, weekly full-volume off-site backup"
            ...
            _s1(TaskWorkflow, "6XYtea+cRizyvEFg6x8/1fO8Auc=");
            _c1 = TaskWorkflow;
    ...
    runtime._h = '18310096361689151513';
...
//# sourceMappingURL=p__Admin__index-async.15410503137710534637.hot-update.js.map
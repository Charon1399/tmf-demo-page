        ...
        "src/pages/Admin/Chat/chat.tsx": function(module, exports, __mako_require__) {
            ...
            const AgentsChat = ({ changeMenu })=>{
                ...
                (0, _react.useEffect)(()=>{
                    ...
                    // }, 3000);
                    } else if (currentScenario === _constants.Scenario.temperatureAbnormal) setTimeout(()=>{
                        changeMenu('assurance-agent', true);
                    }, 2000);
                    else if (currentScenario === _constants.Scenario.serverCanBeHibernated) setTimeout(()=>{
                        changeMenu('assurance-agent', true);
                    }, 2000);
                    else if (currentScenario === _constants.Scenario.bssMetricAbnormal) setTimeout(()=>{
                        changeMenu('assurance-agent', true);
                    }, 2000);
                }, [
                    currentScenario
...
//# sourceMappingURL=p__Admin__index-async.14383469697941653386.hot-update.js.map